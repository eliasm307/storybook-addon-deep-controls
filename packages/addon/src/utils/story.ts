...
> & {
  parameters: {
    ...
    deepControls?: {
      [USER_DEFINED_ARG_TYPE_NAMES]?: Set<string>;
    };
  };
};

const USER_DEFINED_ARG_TYPE_NAMES = Symbol("GeneratedArgType");
...
export function createFlattenedArgs(
  ...
  return flattenObjectRecursively(context.initialArgs, "", {
    ...
    userDefinedArgTypeNames: context.parameters.deepControls![USER_DEFINED_ARG_TYPE_NAMES]!,
  });
}
...
export function createFlattenedArgTypes(
  ...
  context.parameters.deepControls![USER_DEFINED_ARG_TYPE_NAMES] = userDefinedArgTypeNames;
...
function isArgTypeLikelyGeneratedByDocs(argName: string, argType: StrictInputType): boolean {
  ...
  if (argType.control) {
    return false; // docs doesn't seem to include this
  }
